...
-- -----------------------------------------------------
-- Table `mydb`.`belong_to`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`belong_to` (
                                                  `id` INT NOT NULL AUTO_INCREMENT,
                                                  `user_id` INT NOT NULL,
                                                  `organization_id` INT NOT NULL,
                                                  `status` ENUM('active', 'deleted') NOT NULL DEFAULT 'active',
...
-- -----------------------------------------------------
-- Table `mydb`.`recent_contact`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`recent_contact` (
                                                       `contact_id` INT NOT NULL,
                                                       `user_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`token_key`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`token_key` (
                                                  `id` INT NOT NULL AUTO_INCREMENT,
                                                  `user_id` INT NOT NULL,
